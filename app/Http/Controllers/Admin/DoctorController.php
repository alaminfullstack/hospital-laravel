...
class DoctorController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.doctors.create', compact('designations'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($doctor->save()) {
            return redirect()->route('admin.doctors.index')->with('success', 'Doctor Uploaded Successfully');
        }
    ...
    public function edit($id)
    {
        ...
        $designations = Designation::latest()->get();
        return view('admin.doctors.edit', compact('doctor', 'designations'));
    }
