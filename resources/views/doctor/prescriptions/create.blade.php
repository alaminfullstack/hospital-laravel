            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('doctor.prescriptions.index') }}" class="btn btn-primary">View List</a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('doctor.prescriptions.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
